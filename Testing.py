...
menu = {
    ...
    '5': {'item': 'Water', 'price': 1.75}
}

print("Ｖｅｎｄｉｎｇ　Ｍａｃｈｉｎｅ") #When the programs runs, a title will be displayed, via a print statment.

def Display_menu(): #A function to show the user what's available for purchase.
   print("Our menu:")
...
def vending_machine():
    while True:
        Display_menu()  #Shows the user the menu.
        selection = obtain_user_choice() 
        item = menu[selection]['item']
